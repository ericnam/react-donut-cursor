...
// UNUSED EXPORTS: ChangeCursor, DonutCursorProvider
...
var defaultConfig_defaultConfig = {
  center: {
    ...
    hover: _objectSpread(_objectSpread({}, defaultCenterCursor), {}, {
      size: 15,
      transition: 50
    })
  },
  ring: {
    "default": _objectSpread({}, defaultRing)
  }
};
...
var CenterStyle = function CenterStyle(mousePosition, props) {
  return {
    position: "absolute",
    zIndex: 1000,
...
var RingStyle = function RingStyle(mousePosition, props) {
  return {
    position: "absolute",
    zIndex: 1000,
...
var cursor_Cursor = function Cursor(_ref) {
  ...
  var mouseMoveEventListener = function mouseMoveEventListener(e) {
    setMousePosition({
      x: e.x,
      y: e.y
    });
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: CenterStyle(mousePosition, config)
  }), /*#__PURE__*/React.createElement("div", {
    style: RingStyle(mousePosition, config)
  }));
};
...
var CursorStore = /*#__PURE__*/(/* unused pure expression or super */ null && (createContext()));
var DonutCursorProvider = function DonutCursorProvider(_ref) {
  ...
  var config = src_objectSpread(src_objectSpread({}, defaultConfig), configSettings);
  ...
  }, /*#__PURE__*/React.createElement(CursorStore.Provider, {
    value: {
